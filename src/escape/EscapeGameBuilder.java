...
public class EscapeGameBuilder
{
	...
	public EscapeGameManager makeGameManager()
    {
    	...
    	CoordinateType c = gameInitializer.getCoordinateType();
    	EscapeGameManagerImp<IBaseCoordinate> manager =new EscapeGameManagerImp<IBaseCoordinate>(c);
    	
    	
    	//Set the max dimensions
    	manager.setDimensions(gameInitializer.getxMax(), gameInitializer.getyMax());
    	
    	//Set the GamePieces
    	manager.setPieceDescriptors(gameInitializer.getPieceTypes());
    	
    	//Set the locations and player pieces
    	manager.setLocations(gameInitializer.getLocationInitializers());
    	
    	//Set the rules of the game
    	manager.setRules(gameInitializer.getRules());
